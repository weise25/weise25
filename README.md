...
**[LocalSite-AI](https://github.com/weise25/LocalSite-ai)**  
A local alternative to DeepSite. You describe a webpage in plain text, and a local
...
Local AI infrastructure — DSGVO-compliant LLM setups, AI agents, automation,
web development, cybersecurity, DevOps.
